...
class DemoHuadong extends StatefulWidget {
  static const String routeName = '/demo_hudong';

  const DemoHuadong({super.key});

  @override
  createState() => _DemoHadongState();
}

class _DemoHadongState extends State<DemoHuadong> {
...
class VideoPlayerFullPage extends StatefulWidget {
  ...
  @override
  createState() => _VideoPlayerFullPageState();
}
...
class CommentBottomSheet extends StatefulWidget {
  ...
  @override
  createState() => _CommentsBottomSheetState();
}
...
class FullScreenVideoPage extends StatefulWidget {
  ...
  @override
  createState() => _FullScreenVideoPageState();
}
