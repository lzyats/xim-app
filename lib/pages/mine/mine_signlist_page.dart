...
import 'package:alpaca/pages/mine/mine_signlist_controller.dart';
...
// 钱包账单
class MineSignlistPage extends GetView<MineSignlistController> {
  // 路由地址
  static const String routeName = '/mine_signlist';
  const MineSignlistPage({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => MineSignlistController());
    return Scaffold(
      ...
      body: GetBuilder<MineSignlistController>(builder: (builder) {
  ...
  _buildBody() {
    ...
    return ListView.separated(
      ...
      itemBuilder: (ctx, index) {
        ...
        ChatUserSignModel model = controller.refreshList[index];
        String label = '';
        label += '每日签到';
        return Slidable(
          ...
          child: WidgetLineRow(
            ...
            value: model.rewardAmount,
            onTap: () {
              if (model.tradeId != null && model.tradeId.isNotEmpty)
                Get.toNamed(
